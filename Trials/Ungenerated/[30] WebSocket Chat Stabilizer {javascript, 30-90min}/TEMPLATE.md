# TEMPLATE - [30] WebSocket Chat Stabilizer {javascript, 30-90min}

## 1) Trial Identity
- Project: WebSocket Chat Stabilizer
- Stack label: javascript
- Suggested effort: 30-90min
- Request style seed: Cleanup/refactor request mixed with hidden behavior regression
...
- Cleanup/refactor request mixed with hidden behavior regression

## 4) Environment Shape
Build this trial as a human-like codebase, not a polished generated sample.
Use realistic friction such as:
- One key behavior breaks only on an edge-case path
...
- untangling incoherent structure without over-rewriting
